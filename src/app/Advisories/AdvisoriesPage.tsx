...
let AdvisoriesPage: React.FunctionComponent<IAdvisoriesPageProps> = () => (
  <PageSection hasBodyWrapper={false}>
    <EmptyState variant={EmptyStateVariant.full} titleText="Empty State (Stub AdvisoriesPage Module)" icon={CubesIcon}>
      <EmptyStateBody>
        <Content>
          <Content component="p">
