...
let VulnerabilitiesPage: React.FunctionComponent<IVulnerabilitiesPageProps> = () => (
  <PageSection hasBodyWrapper={false}>
    <EmptyState variant={EmptyStateVariant.full} titleText="Empty State (Stub VulnerabilitiesPage Module)" icon={CubesIcon}>
      <EmptyStateBody>
        <Content>
          <Content component="p">
