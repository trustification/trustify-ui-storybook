...
let SBOMsPage: React.FunctionComponent<ISBOMsPageProps> = () => (
  <PageSection hasBodyWrapper={false}>
    <EmptyState variant={EmptyStateVariant.full} titleText="Empty State (Stub SBOMsPage Module)" icon={CubesIcon}>
      <EmptyStateBody>
        <Content>
          <Content component="p">
