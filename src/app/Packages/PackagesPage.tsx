...
export interface IPackagesPageProps {
  sampleProp?: string;
}

// eslint-disable-next-line prefer-const
let PackagesPage: React.FunctionComponent<IPackagesPageProps> = () => (
  <PageSection hasBodyWrapper={false}>
    <EmptyState variant={EmptyStateVariant.full} titleText="Empty State (Stub PackagesPage Module)" icon={CubesIcon}>
      <EmptyStateBody>
        <Content>
          <Content component="p">
